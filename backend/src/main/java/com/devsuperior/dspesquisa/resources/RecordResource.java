...
public class RecordResource {
	...
	//metodo recebe varios parametros para a requisicao
	@GetMapping
	public ResponseEntity<Page<RecordDTO>> findAll(
		...
		if (linesPerPage == 0) {
			linesPerPage = Integer.MAX_VALUE; //pode retornar todos os registros
		}
		
		//usar parameto do spring para paginacao
		PageRequest pageRequest = PageRequest.of(page, linesPerPage, Direction.valueOf(direction), orderBy);
		
		//buscar os regostros no banco
